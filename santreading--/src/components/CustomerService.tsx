...
const serviceTickets = [
  { id: 'TKT-001', customer: 'ABC Construction', type: 'Technical Issue', subject: 'Product defect - Steel rods', priority: 'High', status: 'In Progress', assignee: 'John Silva', created: '2025-10-20' },
  { id: 'TKT-002', customer: 'XYZ Builders', type: 'Complaint', subject: 'Late delivery', priority: 'Medium', status: 'New', assignee: 'Unassigned', created: '2025-10-22' },
  { id: 'TKT-003', customer: 'Prime Projects', type: 'Query', subject: 'Product availability inquiry', priority: 'Low', status: 'Resolved', assignee: 'Sarah Fernando', created: '2025-10-21' },
  { id: 'TKT-004', customer: 'Metro Contractors', type: 'Technical Issue', subject: 'Installation support needed', priority: 'High', status: 'In Progress', assignee: 'David Wickramasinghe', created: '2025-10-23' },
  { id: 'TKT-005', customer: 'ABC Construction', type: 'Feedback', subject: 'Positive feedback on service', priority: 'Low', status: 'Resolved', assignee: 'John Silva', created: '2025-10-19' },
];

const technicians = [
  { id: 1, name: 'John Silva', department: 'Technical Support', active: 12 },
  { id: 2, name: 'Sarah Fernando', department: 'Customer Service', active: 8 },
  { id: 3, name: 'David Wickramasinghe', department: 'Technical Support', active: 15 },
];
...
const feedbacks = [
  { id: 1, customer: 'ABC Construction', rating: 5, comment: 'Excellent service and quick resolution', date: '2025-10-20', ticket: 'TKT-001' },
  { id: 2, customer: 'Prime Projects', rating: 4, comment: 'Good support, helpful staff', date: '2025-10-21', ticket: 'TKT-003' },
  { id: 3, customer: 'Metro Contractors', rating: 5, comment: 'Very satisfied with the technical support', date: '2025-10-22', ticket: 'TKT-004' },
];
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage customer requests and technical support</p>
        </div>
        <Dialog open={isNewTicketOpen} onOpenChange={setIsNewTicketOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Log a new customer request or complaint</DialogDescription>
            </DialogHeader>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <div className="flex justify-between items-center">
                ...
                <div className="relative">
                  ...
                  <Input placeholder="Search tickets..." className="pl-10 w-48" />
                </div>
              </div>
            </Tabs>
          </CardHeader>
                    ...
                    <div key={feedback.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Ticket: {feedback.ticket}</p>
                        </div>
              ...
              <div key={tech.id} className="flex items-center gap-4">
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
                    <span>{tech.name}</span>
                    <span className="text-sm text-gray-600">{tech.active} active tickets</span>
                  </div>
